<template>
  <div id="rg_Study">
    <p class="position"><i class='iconfont'>&#xe8e6;</i>您现在的位置 : 数据加工 > 合并数据 > 学习经历</p>
    <div class="Info_div_box">
      <div class="info_box">
        <div class="list_box">
          <div class="list_l">学校:</div>
          <div class="list_r">
        ...
        <div class="list_box">
          <div class="list_l">专业:</div>
          <div class="list_r">
            <input type="text" class='inp' v-model="originallist.Major">
          </div>
        </div>
        <div class="list_box">
          <div class="list_l">学历:</div>
          <div class="list_r">
            <input type="text" class='inp' v-model="originallist.Degree">
          </div>
        </div>
        <div class="list_box">
      ...
      <div class="info_box" v-for='(list,index) in duplicate' :key="index">
        ...
        <div class="list_box">
          <div class="list_l">时间:</div>
          <div class="list_r">
            <p>{{list.BeginDate | formatDate()}}&nbsp;至&nbsp; {{list.EndDate | formatDate()}}</p>
          </div>
        </div>
        <div class="list_box">
          <div class="list_l">专业:</div>
            ...
            if(resData.code == 0){
              if(resData.result.original){
                ...
                for(let i = 0 ,len = newData.length ;  i< len; i++){
                  ...
                  vm.options[i] = newData[i].College;
